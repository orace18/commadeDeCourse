...
class DriverProfilePage extends GetWidget<ConducteurProfileController> {
  ...
  Widget build(BuildContext context) {
    ...
    String numeroImmatricule = controller.numeroImmatricule.value;
    //recuperer role
    ...
    return Scaffold(
        ...
        body: GetBuilder<ConducteurProfileController>(
            builder: (_) => Column(
                  children: [
                    Expanded(
                      flex: 2,
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        ListTile(
                                          ...
                                          subtitle: Text(numeroImmatricule),
                                        ),
                                      ],
                                    )),
                              ),
